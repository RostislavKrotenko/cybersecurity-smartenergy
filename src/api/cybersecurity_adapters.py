...
def _target_list() -> list[ExternalReadTarget]:
    return [
        ExternalReadTarget(
            ...
            description="Телеметрія gateway через backend Кравченка.",
        ...
        ExternalReadTarget(
            ...
            description="Стан батарейного BMS через read-only API.",
        ...
        ExternalReadTarget(
            ...
            description="Налаштування hybrid inverter без команд керування.",
            url=_env("CYBERSECURITY_INVERTER_URL", "http://backend_dosmukhamedov:6050/api/settings"),
        ),
        ExternalReadTarget(
            id="troian-advisor",
            name="Functional stability advisor",
            component="api",
            protocol="http",
            ...
            description="API функціональної стійкості для рекомендацій.",
        ...
        ExternalReadTarget(
            ...
            description="Read-only API історичних даних поверх InfluxDB.",
        ...
        ExternalReadTarget(
            ...
            description="Health endpoint InfluxDB.",
        ...
        ExternalReadTarget(
            ...
            description="TCP-перевірка доступності MongoDB.",
        ...
        ExternalReadTarget(
            ...
            description="TCP-перевірка MQTT WebSocket broker.",
            host=_env("CYBERSECURITY_MQTT_HOST", "mosquitto"),
        ),
        ExternalReadTarget(
            id="functional-stability-ws",
            name="Functional stability WS",
            component="network",
            protocol="tcp",
            ...
            description="TCP-перевірка WebSocket сервісу функціональної стійкості.",
